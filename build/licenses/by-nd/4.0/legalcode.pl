...
<div class="column is-one-quarter sidebar-container">
  <aside class="menu sidebar-menu">
    <a class="link has-text-black is-block padding-bottom-normal" href="#legal-code-body">Uznanie autorstwa - Bez Utworów Zależnych 4.0 Międzynarodowa</a>
    <ul class="menu-list" >
      <li>
        <ul>
...
></i>
  ...
  <h1 class="b-header">Uznanie autorstwa - Bez Utworów Zależnych 4.0 Międzynarodowa</h1>
</div>
...
></i>
  ...
  <h2 class="b-header has-text-centered">Uznanie autorstwa - Bez Utworów Zależnych 4.0 Międzynarodowa</h2>
</div>
...
<h2 class="margin-bottom-larger b-header is-hidden-touch">Uznanie autorstwa - Bez Utworów Zależnych 4.0 Międzynarodowa</h2>
<h3 class="margin-bottom-larger b-header is-hidden-desktop has-text-centered">Uznanie autorstwa - Bez Utworów Zależnych 4.0 Międzynarodowa</h3>

  <div>
    <h3 class="padding-bottom-normal b-header">Creative Commons Uznanie autorstwa - Bez Utworów Zależnych 4.0 Międzynarodowa</h3>
